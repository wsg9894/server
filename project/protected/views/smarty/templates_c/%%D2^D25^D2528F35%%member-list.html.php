<?php /* Smarty version 2.6.14, created on 2017-12-05 16:06:46
         compiled from market/member-list.html */ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    ...
    <div class="x-body">
      ...
      <xblock>
        <button class="layui-btn" onclick="x_admin_show('添加用户','index.php?r=market/Index/Memberadd',600,400)"><i class="layui-icon"></i>添加</button>
        ...
        <tbody>
          <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  onclick="x_admin_show('编辑','index.php?r=market/Index/Memberedit',600,400)" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
            </td>
          </tr>
