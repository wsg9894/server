<?php /* Smarty version 2.6.14, created on 2017-12-05 16:06:34
         compiled from market/member-edit.html */ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="x-body">
        <form class="layui-form">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_username" name="realname" required="" lay-verify="realname"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <select name="group" id="L_repass" lay-verify="group"
                  autocomplete="off" class="layui-input">
