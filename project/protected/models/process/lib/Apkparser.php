...
/**
 * ApkParser - APK解析类
 * @deprecated 代码来源于网上，没有经过完整、严格测试，使用需谨慎
 * @version V1.1，在原基础上新增加了方法：getPermission（lzz add at 2017-06-26）
 */
...
//----------------------
	...
	public function getPermission() {
		$xml = $this->getXML ();
		$pattern = "/uses-permission android:name=\"(.*)\"/isU";
		$results = preg_match_all ( $pattern, $xml, $res );
		$permissionList = $results ? $res [1] : '';
